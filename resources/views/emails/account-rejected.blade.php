...
<head>
    <meta charset="utf-8">
    <title>Your CIM bank account request was not approved</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 620px; background: #FFFFFF; border: 1px solid #D1D9DA; border-radius: 12px; overflow: hidden;">
                    <tr>
                        <td style="background: #082F54; padding: 24px 28px; color: #FFFFFF;">
                            ...
                            <h1 style="margin: 8px 0 0; font-size: 22px; line-height: 1.3;">Bank account request not approved</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 28px;">
                            ...
                            <p>Your Credit-Intelligence-Mizan (CIM) bank account request was not approved.</p>

                            <p style="margin-bottom: 8px; font-weight: 700; color: #082F54;">Reason:</p>
                            <p style="margin-top: 0; padding: 14px 16px; background: #F7F8FA; border-left: 4px solid #D4A23C; border-radius: 8px;">{{ $reason }}</p>

                            <p>If you believe this is a mistake, please contact the bank or book another appointment.</p>
